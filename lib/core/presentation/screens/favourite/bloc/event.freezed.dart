...
/// @nodoc
class _$LoadCopyWithImpl<$Res> extends _$FavouriteEventCopyWithImpl<$Res>
...
class _$Load with DiagnosticableTreeMixin implements Load {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'FavouriteEvent.load()';
  }

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties..add(DiagnosticsProperty('type', 'FavouriteEvent.load'));
  }
...
abstract class Load implements FavouriteEvent {
